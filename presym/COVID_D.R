...
# source EpiLPS using data set from Backer et al. 2022
incubation_mean <- 4.312
incubation_sd <- 2.4
incubation_shape <- 3.111
incubation_rate <- 0.721
...
intersection <- uniroot(function(x) incubation_pdf(x) - serial_pdf(x), lower = 0.01, upper = 4)$root
